...
function Pricing() {
  ...
  return (
    <section
      id="pricing"
      ref={sectionRef}
      className="relative overflow-hidden bg-[#323232] "
    >
      <Image
      ...
      <div className="relative overflow-hidden 2xl:container 2xl:mx-auto px-4 py-20 sm:p-10 lg:p-14 xl:p-20">
        <div className="relative z-10 space-y-7 xl:space-y-10">
          <div
            className={`pricing-header-animation pricing-header-animation--drift max-w-[500px] space-y-2 lg:space-y-3 xl:max-w-[690px] xl:space-y-4 ${hasEntered ? "is-visible" : ""}`}
          >
                  ...
                  <div className="relative z-0 rounded-2xl p-3 xl:p-4 bg-muted overflow-hidden">
                    <div className="space-y-2 relative z-10">
                      ...
                      <div className=" font-poppins text-white">
                        ...
                        <span className="text-sm xl:text-base leading-8 xl:leading-15 h-fit">
                          /month
                        </span>
                      </div>
